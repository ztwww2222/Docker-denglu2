...
def run(playwright: Playwright) -> None:
    ...
    if bet_pw:
      ...
      if 'Stop' in page_content:
        ...
        print("goorm is running, will restart")
        sys.stdout.flush()
        List.append(f"goorm is running, will restart")
        page.get_by_role("button", name="Stop container").click()
        time.sleep(20)
